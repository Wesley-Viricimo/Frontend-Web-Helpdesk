...
export class TecnicoDeleteComponent implements OnInit {
  ...
  delete(): void {
    this.service.delete(this.tecnico.id).subscribe(() => { //Irá ser feita a chamada do método update da classe tecnicoService
      this.toast.success('Tecnico excluído com sucesso', 'Exclusão');//Se for realizada a atualização do técnico com sucesso irá ser exibida a mensagem
